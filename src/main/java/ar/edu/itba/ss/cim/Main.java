...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Arguments argsObj;
        if (args.length == 0) {
            argsObj = new Arguments(new int[]{400,600,800,1000,1200,1400,1600,1800,2000,2200,2400,2600,2800,3000,3200}, new double[]{20}, 1, 5000, new double[]{1}, Arguments::regularRunner); // Change densityRunner to regularRunner or noiseRunner
