...
\begin{columns}
    \begin{column}{0.7\textwidth}
      \begin{center}
  \animategraphics[loop,controls,width=0.7\linewidth]{30}{animation/low_density/plot_}{0001}{0040}
\end{center}
    \end{column}
...
\begin{columns}
    \begin{column}{0.7\textwidth}
      \begin{center}
  \animategraphics[loop,controls,width=0.7\linewidth]{30}{animation/high_density/plot_}{0001}{0040}
\end{center}
    \end{column}
    \begin{column}{0.3\textwidth}
\begin{center}
...
\begin{columns}
    \begin{column}{0.7\textwidth}
      \begin{center}
  \animategraphics[loop,controls,width=0.7\linewidth]{30}{animation/low_noise/plot_}{0001}{0040}
\end{center}
    \end{column}
    \begin{column}{0.3\textwidth}
\begin{center}
...
\begin{columns}
    \begin{column}{0.7\textwidth}
      \begin{center}
  \animategraphics[loop,controls,width=0.7\linewidth]{30}{animation/high_noise/plot_}{0001}{0040}
\end{center}
    \end{column}
    \begin{column}{0.3\textwidth}
\begin{center}
